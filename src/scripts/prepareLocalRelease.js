...
for (const fileName of ['config.env.local.example', 'Start CoachingOS.bat', 'Install License.bat', 'Enable Network Access.bat', 'Enable HTTPS.bat', 'Enable HTTPS.ps1', 'INSTALLATION GUIDE.txt']) {
